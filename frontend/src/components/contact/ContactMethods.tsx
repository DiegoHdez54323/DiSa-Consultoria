...
const ContactCard3D = ({ method, index }: { method: typeof contactMethods[0]; index: number }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative p-6 rounded-2xl bg-card/80 backdrop-blur-xl border border-border/50 group-hover:border-primary/30 transition-all duration-300 overflow-hidden h-full">
